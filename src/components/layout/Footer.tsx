    ...
    <footer className="py-20 bg-background border-t border-border">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <h3 className="text-xl font-bold mb-4 text-foreground">Shriram Tech Solutions</h3>
              ...
              <div className="flex space-x-4">
                {socialLinks.map(({ icon: Icon, href, label }) => (
                  <a
                    key={label}
                    href={href}
                    className="w-10 h-10 bg-muted border border-border rounded-lg flex items-center justify-center text-muted-foreground hover:bg-primary hover:text-primary-foreground transition-all duration-200"
                    title={label}
                    aria-label={label}
                  >
                    <Icon size={18} />
            ...
            <ul className="space-y-4 mb-8">
              {contactDetails.map(({ icon: Icon, text, href }) => (
                <li key={text} className="flex items-center">
                  ...
                  {href ? (
                    <a href={href} title={text} className="text-sm text-muted-foreground hover:text-primary transition-colors">
                      {text}
                    </a>
                  ) : (
        ...
        <div className="border-t border-border pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6 text-muted-foreground">
              <a href="/about" title="About - Shriram Tech Solutions" className="text-sm hover:text-primary transition-colors">About</a>
              <a href="/privacy" title="Privacy Policy - Shriram Tech Solutions" className="text-sm hover:text-primary transition-colors">Privacy</a>
              <a href="/data-deletion" title="Data Deletion Policy - Shriram Tech Solutions" className="text-sm hover:text-primary transition-colors">Data Deletion</a>
              <a href="/terms" title="Terms of Service - Shriram Tech Solutions" className="text-sm hover:text-primary transition-colors">Terms</a>
              <a href="/#contact" title="Contact - Shriram Tech Solutions" className="text-sm hover:text-primary transition-colors">Contact</a>
            </div>
          </div>
        </div>
      </div>
