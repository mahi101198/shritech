...
export default function AboutPage() {
  const milestones = [
    { year: '2019', title: 'Inception', description: 'Founded with a vision to democratize AI technology for Indian businesses.' },
    { year: '2020', title: 'First Major Success', description: 'Successfully delivered end-to-end automation for a national retail chain.' },
    { year: '2021', title: 'WhatsApp Partnership', description: 'Became certified WhatsApp Business API consultants, expanding communication solutions.' },
    { year: '2022', title: 'Global Expansion', description: 'Started serving international clients in UAE and UK markets.' },
    { year: '2023', title: '50th Project Milestone', description: 'Celebrated delivery of 50th successful enterprise AI implementation.' },
  ]

  const values = [
    { title: 'Innovation', description: 'Constantly exploring new technologies to deliver cutting-edge solutions.' },
    { title: 'Reliability', description: 'Building robust systems that businesses can depend on 24/7.' },
    { title: 'Transparency', description: 'Clear communication and honest consulting throughout the project lifecycle.' },
    { title: 'Excellence', description: 'Committing to the highest quality standards in code and implementation.' },
  ]

  const expertise = [
    { title: 'Machine Learning', description: 'Predictive analytics & classification models', icon: Zap },
    { title: 'Computer Vision', description: 'Object detection & image processing systems', icon: Code },
    { title: 'NLP & Chatbots', description: 'Intelligent conversational agents', icon: MessageCircle },
    { title: 'Process Automation', description: 'End-to-end business workflow automation', icon: Users },
  ]
  ...
  return (
    <Layout>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-left">
            <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6">
              About <span className="text-primary">Shriram Tech</span> Solutions
            </h1>
            ...
            <div className="flex justify-start space-x-12 text-left">
              <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <span className="text-lg font-semibold text-foreground">Certified WhatsApp Business API Partner</span>
              </div>
            </div>
      ...
      <section className="py-20 bg-background transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-left mb-16">
            ...
            <p className="text-lg text-muted-foreground">Building expertise and delivering results since 2019</p>
          </div>

          <div className="relative">
            <div className="absolute left-8 top-0 w-1 h-full bg-border"></div>
            {milestones.map((milestone, index) => (
              <div key={index} className="relative flex items-center mb-12 justify-start pl-16">
                ...
                <div className="absolute left-8 transform -translate-x-1/2 w-4 h-4 bg-primary rounded-full border-2 border-background"></div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {values.map((value, index) => (
              <div key={index} className="bg-card border border-border rounded-xl p-6 transition-colors duration-200 hover:border-primary/50">
      ...
      <section className="py-20 bg-background transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-left mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">Industry Experience & Specializations</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <div className="bg-card border border-border rounded-xl p-6 hover:shadow-lg transition-all duration-200">
              <h3 className="text-xl font-semibold text-foreground mb-4">Restaurant & Food Service</h3>
            ...
            <div className="bg-card border border-border rounded-xl p-6 hover:shadow-lg transition-all duration-200">
              <h3 className="text-xl font-semibold text-foreground mb-4">Manufacturing & Quality Control</h3>
              <p className="text-muted-foreground mb-4">
            ...
            <div className="bg-card border border-border rounded-xl p-6 hover:shadow-lg transition-all duration-200">
              <h3 className="text-xl font-semibold text-foreground mb-4">Healthcare & Document Processing</h3>
              <p className="text-muted-foreground mb-4">
            ...
            <div className="bg-card border border-border rounded-xl p-6 hover:shadow-lg transition-all duration-200">
              <h3 className="text-xl font-semibold text-foreground mb-4">E-commerce & Retail</h3>
              <p className="text-muted-foreground mb-4">
            ...
            <div className="bg-card border border-border rounded-xl p-6 hover:shadow-lg transition-all duration-200">
              <h3 className="text-xl font-semibold text-foreground mb-4">Education & Training</h3>
              <p className="text-muted-foreground mb-4">
      ...
      <section className="py-20 bg-muted/30 transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-left mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">Core Technical Expertise</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {expertise.map((item, index) => (
              <div key={index} className="bg-card border border-border rounded-xl p-6 text-center hover:border-primary/50 transition-all duration-200">
      ...
      <section className="py-20 bg-background transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-left mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">Why Choose Shriram Tech Solutions?</h2>
            <p className="text-lg text-muted-foreground max-w-3xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="bg-card border border-border rounded-xl p-8 hover:border-primary/50 transition-colors duration-200">
            ...
            <div className="bg-card border border-border rounded-xl p-8 hover:border-primary/50 transition-colors duration-200">
              <h3 className="text-2xl font-bold text-foreground mb-4">Technical Excellence</h3>
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-primary rounded-full mr-3 mt-2 flex-shrink-0"></div>
            ...
            <div className="bg-card border border-border rounded-xl p-8 hover:border-primary/50 transition-colors duration-200">
              <h3 className="text-2xl font-bold text-foreground mb-4">Business Impact</h3>
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-primary rounded-full mr-3 mt-2 flex-shrink-0"></div>
      ...
      <section className="py-20 bg-muted/30 transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="bg-card border border-border rounded-xl shadow-sm p-8 hover:border-primary/50 transition-all duration-200">
              <h3 className="text-xl font-bold text-foreground mb-6">AI/ML Technologies</h3>
              <div className="space-y-4">
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-primary rounded-full mr-3"></div>
                  <span className="text-muted-foreground">Python & TensorFlow</span>
                </div>
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-primary rounded-full mr-3"></div>
                  <span className="text-muted-foreground">scikit-learn & pandas</span>
                </div>
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-primary rounded-full mr-3"></div>
                  <span className="text-muted-foreground">spaCy & NLTK for NLP</span>
                </div>
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-primary rounded-full mr-3"></div>
                  <span className="text-muted-foreground">OpenCV for Computer Vision</span>
                </div>
              </div>
            </div>

            <div className="bg-card border border-border rounded-xl shadow-sm p-8 hover:border-primary/50 transition-all duration-200">
              <h3 className="text-xl font-bold text-foreground mb-6">Backend & APIs</h3>
              <div className="space-y-4">
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-primary rounded-full mr-3"></div>
                  <span className="text-muted-foreground">FastAPI for high-performance APIs</span>
                </div>
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-primary rounded-full mr-3"></div>
                  <span className="text-muted-foreground">WhatsApp Business API certified</span>
                </div>
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-primary rounded-full mr-3"></div>
                  <span className="text-muted-foreground">PostgreSQL & Redis databases</span>
                </div>
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-primary rounded-full mr-3"></div>
                  <span className="text-muted-foreground">Docker & Kubernetes deployment</span>
                </div>
              </div>
            </div>

            <div className="bg-card border border-border rounded-xl shadow-sm p-8 hover:border-primary/50 transition-all duration-200">
              <h3 className="text-xl font-bold text-foreground mb-6">Frontend & DevOps</h3>
              <div className="space-y-4">
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-primary rounded-full mr-3"></div>
                  <span className="text-muted-foreground">Next.js & React for modern UIs</span>
                </div>
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-primary rounded-full mr-3"></div>
                  <span className="text-muted-foreground">TypeScript for type safety</span>
                </div>
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-primary rounded-full mr-3"></div>
                  <span className="text-muted-foreground">Tailwind CSS for responsive design</span>
                </div>
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-primary rounded-full mr-3"></div>
                  <span className="text-muted-foreground">AWS & Azure cloud platforms</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-background transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-left mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">Our Proven Development Methodology</h2>
            <p className="text-lg text-muted-foreground max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center group">
              <div className="w-16 h-16 bg-primary text-primary-foreground rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold transition-transform group-hover:scale-110 duration-200">1</div>
              <h3 className="text-xl font-semibold text-foreground mb-3">Discovery & Analysis</h3>
            ...
            <div className="text-center group">
              <div className="w-16 h-16 bg-primary text-primary-foreground rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold transition-transform group-hover:scale-110 duration-200">2</div>
              <h3 className="text-xl font-semibold text-foreground mb-3">Solution Architecture & Design</h3>
              <p className="text-muted-foreground text-left text-sm">
            ...
            <div className="text-center group">
              <div className="w-16 h-16 bg-primary text-primary-foreground rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold transition-transform group-hover:scale-110 duration-200">3</div>
              <h3 className="text-xl font-semibold text-foreground mb-3">Agile Development & Optimization</h3>
              <p className="text-muted-foreground text-left text-sm">
            ...
            <div className="text-center group">
              <div className="w-16 h-16 bg-primary text-primary-foreground rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold transition-transform group-hover:scale-110 duration-200">4</div>
              <h3 className="text-xl font-semibold text-foreground mb-3">Deployment & Ongoing Partnership</h3>
              <p className="text-muted-foreground text-left text-sm">
      ...
      <section className="py-20 bg-muted/30 transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-left mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">Client Success Stories & Case Studies</h2>
            <p className="text-lg text-muted-foreground max-w-4xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <div className="bg-card border border-border rounded-xl shadow-sm p-8 hover:border-primary/50 transition-colors duration-200">
              <h3 className="text-2xl font-bold text-foreground mb-4">Restaurant Chain Transformation</h3>
              <p className="text-muted-foreground mb-4">
              ...
              <div className="bg-secondary/5 p-4 rounded-lg text-sm">
            ...
            <div className="bg-card border border-border rounded-xl shadow-sm p-8 hover:border-primary/50 transition-colors duration-200">
              <h3 className="text-2xl font-bold text-foreground mb-4">Manufacturing Quality Control Revolution</h3>
              <p className="text-muted-foreground mb-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-card border border-border rounded-xl shadow-sm p-8 hover:border-primary/50 transition-colors duration-200">
              <h3 className="text-2xl font-bold text-foreground mb-4">Healthcare Document Processing</h3>
              <p className="text-muted-foreground mb-4">
            ...
            <div className="bg-card border border-border rounded-xl shadow-sm p-8 hover:border-primary/50 transition-colors duration-200">
              <h3 className="text-2xl font-bold text-foreground mb-4">E-commerce Growth Acceleration</h3>
              <p className="text-muted-foreground mb-4">
      ...
      <section className="py-20 bg-background transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-left mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">Our Team & Leadership</h2>
            <p className="text-lg text-muted-foreground max-w-4xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
            <div>
              <h3 className="text-2xl font-bold text-foreground mb-6">Leadership & Vision</h3>
              ...
              <div className="bg-card border border-border p-6 rounded-lg">
                <h4 className="font-semibold text-foreground mb-3">Leadership Principles:</h4>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-muted/50 p-4 rounded-lg">
                  <h4 className="font-semibold text-foreground mb-2">AI/ML Engineers</h4>
                  <p className="text-sm text-muted-foreground">Specialized in deep learning, model optimization, and production deployment</p>
                </div>
                <div className="bg-muted/50 p-4 rounded-lg">
                  <h4 className="font-semibold text-foreground mb-2">Data Scientists</h4>
                  <p className="text-sm text-muted-foreground">Expert in data analysis, feature engineering, and statistical modeling</p>
                </div>
                <div className="bg-muted/50 p-4 rounded-lg">
                  <h4 className="font-semibold text-foreground mb-2">Software Developers</h4>
                  <p className="text-sm text-muted-foreground">Skilled in full-stack development, API integration, and system architecture</p>
                </div>
                <div className="bg-muted/50 p-4 rounded-lg">
                  <h4 className="font-semibold text-foreground mb-2">DevOps Specialists</h4>
                  <p className="text-sm text-muted-foreground">Expert in cloud deployment, CI/CD pipelines, and infrastructure management</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-muted/30 transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-left mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">Quality Assurance & Industry Standards</h2>
            <p className="text-lg text-muted-foreground max-w-4xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <div className="bg-card border border-border rounded-xl shadow-sm p-8 hover:border-primary/50 transition-colors duration-200">
              <h3 className="text-2xl font-bold text-foreground mb-6">Development Standards</h3>
              <p className="text-muted-foreground mb-6">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-primary pl-4">
                  <h4 className="font-semibold text-foreground mb-2">Code Quality Standards</h4>
                ...
                <div className="border-l-4 border-primary pl-4">
                  <h4 className="font-semibold text-foreground mb-2">Testing Protocols</h4>
                  <p className="text-muted-foreground text-sm">
            ...
            <div className="bg-card border border-border rounded-xl shadow-sm p-8 hover:border-primary/50 transition-colors duration-200">
              <h3 className="text-2xl font-bold text-foreground mb-6">Performance & Reliability</h3>
              <p className="text-muted-foreground mb-6">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-primary pl-4">
                  <h4 className="font-semibold text-foreground mb-2">Performance Monitoring</h4>
                  <p className="text-muted-foreground text-sm">
                ...
                <div className="border-l-4 border-primary pl-4">
                  <h4 className="font-semibold text-foreground mb-2">Reliability Engineering</h4>
                  <p className="text-muted-foreground text-sm">
                ...
                <div className="border-l-4 border-primary pl-4">
                  <h4 className="font-semibold text-foreground mb-2">Scalability Planning</h4>
                  <p className="text-muted-foreground text-sm">
          ...
          <div className="bg-card border border-border rounded-xl p-8 hover:border-primary/50 transition-colors duration-200">
            <h3 className="text-2xl font-bold text-foreground mb-6">Certifications & Compliance</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Award className="w-8 h-8 text-primary" />
                </div>
                <h4 className="font-semibold text-foreground mb-2">WhatsApp Business API</h4>
                <p className="text-muted-foreground text-sm">
      ...
      <section className="py-20 bg-background transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">Our Future Vision & Roadmap</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-bold text-foreground mb-6">Technology Innovation</h3>
              <p className="text-muted-foreground mb-6">
              ...
              <div className="bg-muted/50 p-6 rounded-lg border border-border">
                <h4 className="font-semibold text-foreground mb-3">Innovation Focus Areas:</h4>
                <ul className="space-y-2 text-muted-foreground">
                  <li className="flex items-start">
                    <div className="w-2 h-2 bg-primary rounded-full mr-3 mt-2 flex-shrink-0"></div>
            ...
            <div>
              <h3 className="text-2xl font-bold text-foreground mb-6">Market Expansion</h3>
              <p className="text-muted-foreground mb-6">
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="bg-muted/50 p-4 rounded-lg border border-border">
                  <h4 className="font-semibold text-foreground mb-2">Industry Diversification</h4>
                  <p className="text-sm text-muted-foreground">
                ...
                <div className="bg-muted/50 p-4 rounded-lg border border-border">
                  <h4 className="font-semibold text-foreground mb-2">Partnership Development</h4>
                  <p className="text-sm text-muted-foreground">
